...
# 5. Full encrypt and decrypt
rc4_decrypted_file_path = rc4_decrypt_file('Docs\RC4-ENAES-ENdoc1.docx', or_key_RC4)

final_decrypted_file_path = aes_decrypt_file(rc4_decrypted_file_path, or_key_AES)